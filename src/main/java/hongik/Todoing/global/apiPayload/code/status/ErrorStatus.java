...
public enum ErrorStatus implements BaseErrorCode {
    ...
    EMAIL_DUPLICATED(HttpStatus.BAD_REQUEST, "4005", "이메일이 중복되었습니다."),
    // 401 UNAUTHORIZED
    ...
    INVALID_PASSWORD(HttpStatus.UNAUTHORIZED, "4014", "비밀번호가 일치하지 않습니다."),
    INVALID_TOKEN(HttpStatus.UNAUTHORIZED, "4015", "유효하지 않은 토큰입니다."),
    // 403 FORBIDDEN
    FORBIDDEN(HttpStatus.FORBIDDEN, "403", "접근이 금지된 사용자입니다."),
    COMMUNITY_ADMIN_FORBIDDEN(HttpStatus.FORBIDDEN, "4031", "커뮤니티 관리자 권한이 없습니다."),
    // 404 NOT_FOUND
    ...
    MEMBER_NOT_FOUND_BY_EMAIL(HttpStatus.NOT_FOUND, "4044", "이메일로 멤버를 찾을 수 없습니다."),
    // 409 CONFLICT
